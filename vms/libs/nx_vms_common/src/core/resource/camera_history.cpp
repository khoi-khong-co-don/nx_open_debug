...
nx::vms::api::CameraHistoryItemDataList::const_iterator getMediaServerOnTimeInternal(
    ...
    qint64 timestamp)
{
    qDebug() << "KHOI getMediaServerOnTimeInternal";
...
{
    qDebug() << "KHOI QnCameraHistoryPool";
...
{
    qDebug() << "KHOI setMessageProcessor";
...
{
    qDebug() << "KHOI isCameraHistoryValid";
