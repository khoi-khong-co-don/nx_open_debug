...
//        if(!frame.empty())
//        {
//            qDebug() << "LUU ANH 3 " << filePath.c_str();
//             bool result = cv::imwrite(filePath, frame);
//             if (result)
//             {
//                 frame.release();
//             }
...
//        try{
//            qDebug() << "luu_img ";
//            cv::Mat img(picture->height,
//                        picture->width,
//                        CV_8UC3,
//                        picture->data[0]);
////        std::thread eventListener(luu_img, img);
////        img.release();
//            qDebug() << "LUU ANH 2";
